...
export function currentEngagement(): Engagement {
  return {
    ...
    engagement_users: [{ uuid: 'a', first_name: 'a', last_name: 'a', email: 'a@aol.com', role: 'a'}, 
                       { uuid: 'b', first_name: 'b', last_name: 'b', email: 'b@bol.com', role: 'b'},
                       { uuid: 'c', first_name: 'c', last_name: 'c', email: 'c@aol.com', role: 'c'}],
    participant_count: 3,
    engagement_lead_email: 'alice@doe.com',
    engagement_lead_name: `Alice Doe`,
    engagement_type: 'Residency',
